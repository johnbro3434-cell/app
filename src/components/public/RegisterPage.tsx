    ...
    <div id="register-page-root" className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-7 p-7 sm:p-9 glass-panel rounded-3xl relative overflow-hidden">
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-emerald-500/15 border border-emerald-500/30 text-emerald-300 text-xs font-bold uppercase tracking-wider backdrop-blur-md shadow-[0_0_15px_rgba(16,185,129,0.2)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <span className="text-[11px] text-slate-400 mt-1 block">
              রেফার কোড ছাড়া একাউন্ট খোলা যাবে না। রেফার কোড না থাকলে ইনভাইটকারীর থেকে সংগ্রহ করুন বা অফিসিয়াল কোড <button type="button" onClick={() => setReferralCode('EHBD1001')} className="text-purple-300 font-bold underline hover:text-purple-200 cursor-pointer">EHBD1001</button> ব্যবহার করুন।
            </span>
          </div>

          <div className="p-3.5 rounded-xl glass-card text-[11px] text-slate-300 space-y-1">
            <div className="flex items-center gap-1.5 text-emerald-400 font-bold">
              <CheckCircle className="w-3.5 h-3.5" />
              <span>4-Day Free Trial Activated Automatically</span>
            </div>
            <p className="text-slate-300 leading-relaxed">1 video task daily (25 TK/day) = 100 TK total. Single trial withdrawal permitted per device.</p>
          </div>
